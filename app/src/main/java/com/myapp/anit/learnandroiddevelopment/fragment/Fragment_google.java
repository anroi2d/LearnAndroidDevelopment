...
public class Fragment_google extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_google);

        list = new ArrayList<>();

        list.add(new UIWidgets("AdView", R.drawable.textview));
        list.add(new UIWidgets("MapView", R.mipmap.ic_launcher));
